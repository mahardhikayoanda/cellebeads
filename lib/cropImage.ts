...
/**
 * This function takes the raw image source and the cropped area coordinates
 * and returns a "Blob" (a file-like object) of the cropped image.
 */
export default async function getCroppedImg(
  ...
  return new Promise((resolve, reject) => {
    ...
    }, 'image/jpeg', 0.9) // Output sebagai JPEG kualitas 90%
  })
}