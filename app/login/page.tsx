...
// 2. Pindahkan logika utama ke komponen terpisah (misal: LoginForm)
function LoginForm() {
  ...
  // useSearchParams aman digunakan di sini karena komponen ini akan di-Suspense
...
// 3. Komponen Utama (Default Export) yang membungkus dengan Suspense
export default function LoginPage() {
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-200px)] p-4"> 
      ...
      >
        {/* Fallback UI ditampilkan saat parameter URL sedang dimuat */}
