        ...
        >
          {items.map((item, index) => (
            ...
            >
              ...
              <TableCell className="text-right text-stone-600 whitespace-nowrap">Rp {item.price.toLocaleString('id-ID')}</TableCell>
              <TableCell className="text-right pr-6 font-bold text-emerald-600 whitespace-nowrap">
